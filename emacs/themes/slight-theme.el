...
;;; Commentary:
;;; slight theme created by Sampie159 in 2024
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-buffer-id ((,class (:bold nil :foreground ,func :background ,unspec))))
   ...
   `(org-level-1 ((,class (:bold nil :foreground ,fg2 :height 1.1))))
   `(org-level-2 ((,class (:bold nil :foreground ,fg3))))
   `(org-level-3 ((,class (:bold nil :foreground ,fg4))))
   ...
   `(helm-ff-invalid-symlink ((,class (:foreground ,warning2 :background ,bg1 :weight normal))))
   ...
   `(company-tooltip ((,class (:foreground ,fg2 :background ,bg2 :bold nil))))
...
(provide-theme 'slight)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; slight-theme.el ends here
